    ...
    const features = [
        {
            ...
            description: (
                <>
                    Design requests in UI and get contracts, JSON Schemas, and examples instantly. <span className="font-medium text-neutral-900">Reuse variables/function, keep everything versioned in Git</span>
                </>
            ),
            icon: (
        ...
        },
        {
            ...
            icon: (
                <svg className="size-8 mb-2" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M17.3023 14.3007C17.4865 14.4777 17.4866 14.7723 17.3024 14.9494L14.262 17.8735C13.9761 18.1485 13.5 17.9459 13.5 17.5492L13.5 11.7043C13.5 11.3077 13.9759 11.1051 14.2619 11.3798L17.3023 14.3007Z" fill="#55A76A" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M8.57537 14.9493C8.39147 14.7723 8.39155 14.4779 8.57555 14.3009L11.6118 11.3808C11.8977 11.1059 12.3738 11.3085 12.3738 11.7051V17.5485C12.3738 17.9453 11.8975 18.1478 11.6116 17.8726L8.57537 14.9493Z" fill="#E55765" />
                </svg>
        ...
        },
        {
            ...
            icon: (
                <svg className="size-8 mb-2" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect x="1.40625" y="5.90625" width="15.1875" height="0.5625" stroke="#DB3B4B" strokeWidth="0.5625" />
                </svg>
        ...
        },
        {
            ...
            icon: (
                <svg className="size-8 mb-2" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M2 3.16667V6.66667C2 7.311 2.52233 7.83333 3.16667 7.83333H14.8333C15.4777 7.83333 16 7.311 16 6.66667V3.16667C16 2.52233 15.4777 2 14.8333 2H3.16667C2.52233 2 2 2.52233 2 3.16667ZM3.16667 6.66667V3.16667H14.8333L14.8333 6.66667H3.16667Z" fill="#208A3C" />
                    <path d="M6.66667 12.5H4.33333V13.6667H6.66667V12.5Z" fill="#208A3C" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M2 11.3333V14.8333C2 15.4777 2.52233 16 3.16667 16H14.8333C15.4777 16 16 15.4777 16 14.8333V11.3333C16 10.689 15.4777 10.1667 14.8333 10.1667H3.16667C2.52233 10.1667 2 10.689 2 11.3333ZM3.16667 14.8333V11.3333H14.8333L14.8333 14.8333H3.16667Z" fill="#208A3C" />
                </svg>
