...
const DemoScreensSection = () => {
    ...
    return (
        <LayoutContainer>
            ...
            <div className="grid grid-cols-2 gap-4 md:flex md:flex-row md:flex-wrap justify-center md:gap-6 lg:gap-10 w-full md:w-auto mt-8">
