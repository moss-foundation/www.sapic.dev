        ...
        <section className="relative h-full">
            <LayoutContainer className="py-12 border-l border-r  border-dashed border-(--default-border-color) bg-[#fdfdf8]">
                ...
                <div className="grid grid-cols-2 grid-rows-[repeat(10,minmax(0,auto))] border-b border-dashed border-(--default-border-color)">
                    <p className="text-6xl font-serif font-medium text-black text-balance leading-tight text-left row-span-3 border-b border-dashed border-(--default-border-color) pt-[60px] pb-[30px]">
                    ...
                    <div className="row-start-6 row-span-5 col-start-1 border-t border-r border-dashed border-(--default-border-color) p-3">
                        <img
                            src={FAQSectionImage}
