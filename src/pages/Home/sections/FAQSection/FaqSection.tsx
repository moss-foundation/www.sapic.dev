            ...
            <LayoutContainer className="border-l  border-r border-dashed border-(--default-border-color) bg-[#fdfdf8]">
                <div className="grid grid-cols-2">
                    <div className="border-r border-dashed border-(--default-border-color)">
                        <p className="flex flex-col items-start px-2.5 text-5xl font-serif font-medium text-black text-balance leading-tight text-left border-b border-dashed border-(--default-border-color) pt-[80px] pb-[42px]">
