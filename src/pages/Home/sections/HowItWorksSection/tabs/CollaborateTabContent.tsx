...
const CollaborateTabContent = () => {
    ...
    return (
        <div className="flex flex-col gap-y-6 lg:gap-y-8">
            ...
            <div ref={containerRef} className="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-neutral-200 gap-6 lg:gap-x-20">
                <div
                    ref={leftBlockRef}
                    className="w-full lg:w-1/2 lg:max-h-[50vh] overflow-y-auto relative [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] lg:cursor-none"
                    onMouseMove={handleLeftMouseMove}
                >
                    <div className="flex flex-col">
                        <div className="flex flex-col gap-y-1.5 py-6 lg:py-8">
                            <div className="mb-2 lg:mb-2.5 flex h-6 w-6 items-center justify-center rounded-full bg-purple-600">
                                <span className="text-xs font-semibold text-white">1</span>
                            </div>
                            <h3 className="mb-1 text-base md:text-lg font-semibold text-gray-900">VCS Collaboration</h3>
                            ...
                            <div className="mt-4 lg:mt-5 flex max-w-full md:max-w-2xl gap-3 md:gap-4 lg:pr-10">
                ...
                <div ref={rightBlockRef} className="w-full lg:w-1/2 lg:max-h-[50vh] overflow-hidden">
                    <div className="flex flex-col gap-y-1.5 py-6 lg:py-8">
                        <div className="mb-2 lg:mb-2.5 flex h-6 w-6 items-center justify-center rounded-full bg-lime-600">
                            <span className="text-xs font-semibold text-white">2</span>
                        </div>
                        <h3 className="mb-1 text-base md:text-lg font-semibold text-gray-900">Cloud Collaboration</h3>
                        <p className="text-sm text-neutral-600">
