                        ...
                        >
                            ...
                            <div className="md:hidden flex items-center gap-2">
                                <Button
                                    variant="primary"
                                    size="small"
                                    onClick={() => openWaitList('header_mobile')}
                                >
                                    Get Started
                                </Button>
                                <button
                                ...
                                <LayoutContainer>
                                    ...
                                    >
                                        <Button
                                            ...
                                            size="large"
                                            className="w-full"
                                            onClick={() => handleDiscordClick('header_mobile')}
                                        >
                                            Join our Discord
                                        </Button>
                                    </motion.div>
