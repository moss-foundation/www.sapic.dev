...
const Badge = ({ text, content }: BadgeProps) => {
    return (
        <div className="inline-flex items-center p-1 rounded-full border-dashed border border-[#D4E2FF] hover:border-solid bg-[#EDF3FF] px-2 cursor-pointer transition-all duration-200 ">
